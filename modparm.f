...
!    Drainmod tile equations  01/2006
      ...
      integer :: no_lup, no_up, nostep, soc_id        ! soc_id for the current scenario of water reduction 1: 25%, 2: 50%, 3: 100%
      integer :: current_lup_id                       ! selected lup scenario ID based on March reservoir volume
      integer :: soclup_log_unit                      ! Log file unit for socio-economic LUP changes
...
!!    adding qtile to output.hru write 3/2/2010 gsm  increased heds(70) to heds(71)
      ...
      character(len=20), dimension(100) :: fname_soc      !    file name for the socio-economic scenario in soclup.dat
